...
# Change ID 
the id of each image is stored as UUID in raw data format. We translate it to something more usefull, i.e. non raw data. 
```{r}
...
```{r}
full_db <- c()
full_db <- left_join(skopy_db[[1]],skopy_db[[6]],by = 'id')
