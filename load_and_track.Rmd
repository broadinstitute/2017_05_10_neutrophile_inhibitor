...
data_dir <- '../../analysis/2017_05_10_neutrophils_cp17_sp17/'
data_dir_no_lap <- '../../analysis/2017_05_10_neutrophils_cp17_sp17_no_lap/'
data_dir_no_lap_smooth <- '../../analysis/2017_05_10_neutrophils_cp17_sp17_no_lap_smooth/'
...
```{r}
tracks_cp <- track_data(data_dir, csv_in_name, strata, 'TrackObjects_Label')
write_csv(tracks_cp,file.path(data_dir, csv_tracks_name))

tracks_cp_no_lap <- track_data(data_dir_no_lap, csv_in_name, strata, 'TrackObjects_Label_50')
write_csv(tracks_cp_no_lap,file.path(data_dir_no_lap, csv_tracks_name))

tracks_cp_no_lap_smooth <- track_data(data_dir_no_lap_smooth, csv_in_name, strata, 'TrackObjects_Label_50')
write_csv(tracks_cp_no_lap_smooth,file.path(data_dir_no_lap_smooth, csv_tracks_name))
