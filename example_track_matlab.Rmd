...
plot.windrose(spd = CP17$Track_Speed, dir = (180 * (CP17$Track_Angle) / pi), spdmax = 10)
plot.windrose(spd = SP17$Track_Speed, dir = (180 * (SP17$Track_Angle) / pi), spdmax = 10)

plot.windrose(spd = controls$Track_Speed, dir = (180 * (controls$Track_Angle) / pi), spdmax = 10)
plot.windrose(spd = vehicle$Track_Speed, dir = (180 * (vehicle$Track_Angle) / pi), spdmax = 10)
```
